...
<div class="testbox">
      <form action="" method="POST">
        <h1>Book Customer Feedback Form</h1>
        <h4>Library Name<span>*</span></h4>
        ...
        <select name="Feedback_EnquiryOn">
          ...
          <option value="2">Library Environment</option>
        ...
        <h4>Name of the Librarian who served you</h4>
        <input type="text" name="LibrarianName"/>
        <h4>Book You have Read or take</h4>
    ...
    <?php
      if(isset($_POST['Submit'])){
        ...
        try{
          $sql = "INSERT Into booksurvey SET
          ...
          if($res==true){
            ?>
            <script>
              window.location.href = "http://localhost:8080/dbms/syed/book.php";
            </script>
            <?php
          }
