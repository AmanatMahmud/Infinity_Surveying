...
<div class="testbox">
      <form action="" method="POST">
        <h1>Food Customer Feedback Form</h1>
        <h4>Restaurent Name<span>*</span></h4>
        ...
        <select name="Feedback_EnquiryOn">
          <option selected hidden value=" "></option>
          <option value="1">Restaurent service</option>
          <option value="2">Restaurent environment</option>
          <option value="3">Food grade</option>
        ...
        <h4>Name of the Waiter who served you</h4>
        <input type="text" name="wname"/>
        <h4>Food You have Tasted</h4>
    ...
    <?php
      if(isset($_POST['Submit'])){
        ...
        try{
          $sql = "INSERT Into foodsurvey SET
          Rname = '$Rname',
          ...
          if($res==true){
            ?>
            <script>
              window.location.href = "http://localhost:8080/dbms/syed/food.php";
            </script>
            <?php
          }
