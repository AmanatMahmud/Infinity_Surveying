...
<body>
    <div class="testbox">
        <form action="" method="POST">
            <h1>Medical Questionnaire Form</h1>
            <h4>Medical Name<span>*</span></h4>
            <input type="text" name="MedicalName" required />
            ...
            <select name="Feedback_EnquiryOn">
                ...
                <option value="3">Insurance policy</option>
    ...
    ?>
                <script>
                    window.location.href = "http://localhost:8080/dbms/ROHAN/Medical.php";
                </script>
            <?php
            }
            ...
            ?>
            <script>
                window.location.href = "http://localhost:8080/dbms/ROHAN/Medical.phpp";
            </script>
    <?php
        }
    }
